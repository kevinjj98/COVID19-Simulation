...
function setup() {
  ...
  while (dots.length < population) {
    ...
    if (!overlapping) {
      //75% chance that this dot will not move
...
function draw() {
  ...
  healthyLines.push(new HealthyLine(250 + millis() * 0.01, 10, 250 + millis() * 0.01, 80));
  ...
  strokeWeight(2);
  if (numRecovered > 0) {
    recoveredLines.push(new RecoveredLine(250 + millis() * 0.01, 10, 250 + millis() * 0.01, map(numRecovered, 0, population, 10, 80)));
  }
  ...
  stroke(255, 0, 50);
  strokeWeight(2);
    sickLines.push(new SickLine(250 + millis() * 0.01, 80, 250 + millis() * 0.01, map(numSick, 0, population, 80, 10)));
